...
const links: LinkItem[] = [
    ...
    },
    {
        label: "建议反馈",
        buttons: [
            {icon: <LikeOutlined/>, href: "mailto:xyk953651094@qq.com?&subject=云开壁纸新标签页-功能建议", text: "功能建议"},
            {icon: <DislikeOutlined/>, href: "mailto:xyk953651094@qq.com?&subject=云开壁纸新标签页-问题反馈", text: "问题反馈"},
        ],
    },
];
