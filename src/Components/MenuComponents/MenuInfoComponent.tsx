...
const links: LinkItem[] = [
    {
        label: "插件主页",
        buttons: [
            {icon: <GithubOutlined/>, href: "https://github.com/xyk953651094/SkyImageNewTab/", target: "_blank", text: "Github"},
            {icon: <GitlabOutlined/>, href: "https://gitlab.com/xyk953651094/SkyImageNewTab/", target: "_blank", text: "Gitlab"},
        ],
    },
    {
        label: "作者主页",
...
function MenuInfoComponent(props: MenuInfoComponentProps) {
    ...
    return (
        <Card title={"关于云开壁纸新标签页（ V" + version + " ）"} extra={<InfoCircleOutlined />}
              styles={{
                  root: {
