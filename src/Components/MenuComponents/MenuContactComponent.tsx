...
const contactLinks: ContactLink[] = [
    ...
    {icon: <LikeOutlined/>, href: "mailto:xyk953651094@qq.com?&subject=云开壁纸新标签页-功能建议", label: "功能建议"},
    {icon: <DislikeOutlined/>, href: "mailto:xyk953651094@qq.com?&subject=云开壁纸新标签页-问题反馈", label: "问题反馈"},
];
